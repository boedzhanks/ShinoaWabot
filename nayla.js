...
// FAKE REPLY
nay1 = {key: {fromMe: true,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: from } : {})},message: {"extendedTextMessage": {"text": `Halo! : ${pushname} 👋`}}}
// CONST SEND MESSAGE
...
{"urlButton": {"displayText": "SOURCE CODE","url": "https://github.com/Towartz"}},
...
if (satu == 'stickers') {nayla.sendMessage(from, {sticker:{url:dua}},{quoted: {key: {fromMe: true,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: from } : {})},message: {"extendedTextMessage": {"text": tiga}}}})}
...
◍ *MEGAWATI*
◍ *Diki Dev*`
await sendMenu(from, menuu, "Lightweight full-featured WhatsApp Web + Multi-Device API",{quoted:nay1})
break
case 's':
case 'sticker':
case 'stiker':
